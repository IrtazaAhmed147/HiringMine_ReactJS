...
import './SwitchCom.css'
import { useDispatch, useSelector } from 'react-redux'
import { darkTheme, lightTheme } from '../../redux/themeSlice.js'
    ...
    return (
        <>
            ...
            <label id="theme-toggle-button">
                <input onChange={handleTheme} checked={theme === 'dark' ? true : false} type="checkbox" id="toggle" />
